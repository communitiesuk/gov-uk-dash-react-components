...
var AutoComplete = function AutoComplete() {
  ...
  var handleInputChange = function handleInputChange(event) {
    ...
    var queryChanged = query !== event.target.value;
    var queryLongEnough = query.length >= minLength;
    setQuery(event.target.value);
    setAriaHint();
    var searchForOptions = showAllValues || query.length && queryChanged && queryLongEnough;

    if (searchForOptions) {
      dataSource(query, function (options) {
...
//# sourceMappingURL=dba1df7-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJkYmExZGY3LW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==