...
var AutoComplete = function AutoComplete(props) {
  ...
  var _useState17 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
      ...
      showErrorMessage = _useState18[0],
      setShowErrorMessage = _useState18[1];
  ...
  var handleComponentBlur = function handleComponentBlur(newState, escape) {
    ...
    setQuery(newQuery);
    setSelected(null);
    var validQuery = isQueryAnOption(newQuery, options);
  ...
  var handleUpArrow = function handleUpArrow(event) {
    ...
    if (selectElement && isMenuOpen === false) {
      ...
      var allowMoveUp = isNotAtTop && isMenuOpen; // if (allowMoveUp || selectElement) {
      ...
      if (isNotAtTop) {
        ...
        while (selected - i !== -1 && ((_nextValidOption = nextValidOption) === null || _nextValidOption === void 0 ? void 0 : _nextValidOption.disabled) === true) {
          var _nextValidOption;
  ...
  var selectAllTextInInput = function selectAllTextInInput() {
    var inputElement = elementReferences[-1];
    inputElement.setSelectionRange(0, inputElement.value.length);
  };

  var previousFocus = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])();
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    var componentLostFocus = isFocus === null;
    var componentGainedFocus = previousFocus.current === null;
    var focusChangedWithinComponent = !componentLostFocus && !componentGainedFocus;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, showErrorMessage && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
      ...
      className: option.disabled === true ? "".concat(optionClassName, " ").concat(optionClassName, "--no-results") : "".concat(optionClassName).concat(optionModifierFocused).concat(optionModifierOdd),
      dangerouslySetInnerHTML: {
...
//# sourceMappingURL=655b483-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI2NTViNDgzLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==