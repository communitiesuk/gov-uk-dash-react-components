...
export 'govuk'_checkboxlist

"""
    'govuk'_checkboxlist(;kwargs...)
...
"""
function 'govuk'_checkboxlist(; kwargs...)
        available_props = Symbol[:id, :options, :value]
        wild_props = Symbol[]
        return Component("'govuk'_checkboxlist", "CheckboxList", "uk_gov_dash_components", available_props, wild_props; kwargs...)
end
