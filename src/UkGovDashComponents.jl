...
function __init__()
    ...
    external_url = "https://unpkg.com/uk_gov_dash_components@1.0.0-beta.7/uk_gov_dash_components/async-UkGovDashComponents.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/uk_gov_dash_components@1.0.0-beta.7/uk_gov_dash_components/async-UkGovDashComponents.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
