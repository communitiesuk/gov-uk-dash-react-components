...
function __init__()
    ...
    external_url = "https://unpkg.com/uk_gov_dash_components@1.2.0/uk_gov_dash_components/async-UkGovDashComponents.js",
    dynamic = nothing,
    async = :true,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/uk_gov_dash_components@1.2.0/uk_gov_dash_components/async-UkGovDashComponents.js.map",
    dynamic = true,
    async = nothing,
    type = :js
),
