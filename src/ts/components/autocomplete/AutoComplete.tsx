...
import {
    ...
    RealAutoCompleteOptions
} from "./types";
import {
    isAutoCompleteOptionsAJustAValue,
    isAutoCompleteOptionsALabelValueObj,
    isAutoCompleteOptionsANameValueObj,
    isAutoCompleteOptionsHasValueObject
} from "./utils";
import {
    AutoCompleteTypes,
...
/**
 * @description React component to support auto complete / dropdown box
 */
