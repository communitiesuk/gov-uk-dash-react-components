...
'govuk'AutoComplete <- function(id=NULL, alwaysDisplayArrow=NULL, ariaLabelledBy=NULL, autoselect=NULL, confirmOnBlur=NULL, cssNamespace=NULL, displayMenu=NULL, dropdownArrow=NULL, minLength=NULL, name=NULL, onConfirm=NULL, placeholder=NULL, required=NULL, rerender=NULL, selectElement=NULL, showAllValues=NULL, showNoOptionsFound=NULL, source=NULL, style=NULL, tAssistiveHint=NULL, tNoResults=NULL, tStatusNoResults=NULL, tStatusQueryTooShort=NULL, tStatusResults=NULL, tStatusSelectedOption=NULL, templates=NULL, value=NULL, wrapperRef=NULL) {
    ...
    component <- list(
        ...
        propNames = c('id', 'alwaysDisplayArrow', 'ariaLabelledBy', 'autoselect', 'confirmOnBlur', 'cssNamespace', 'displayMenu', 'dropdownArrow', 'minLength', 'name', 'onConfirm', 'placeholder', 'required', 'rerender', 'selectElement', 'showAllValues', 'showNoOptionsFound', 'source', 'style', 'tAssistiveHint', 'tNoResults', 'tStatusNoResults', 'tStatusQueryTooShort', 'tStatusResults', 'tStatusSelectedOption', 'templates', 'value', 'wrapperRef'),
