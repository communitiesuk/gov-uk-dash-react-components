...
#' @export
'govuk'status <- function(id=NULL, length=NULL, minQueryLength=NULL, queryLength=NULL, selectedOption=NULL, selectedOptionIndex=NULL, tNoResults=NULL, tQueryTooShort=NULL, tResults=NULL, tSelectedOption=NULL) {
